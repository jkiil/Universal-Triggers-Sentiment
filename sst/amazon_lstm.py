...
def main(dataset_label_filter, test_triggers, model_no_str):
    ...
    tokenizers = {"tokens": RegexpTokenizer(r'\w+\'?\w*')}
    ...
    model_path = "tmp\\" + EMBEDDING_TYPE + "_amazon_" + dataset_label_filter + "_" + model_no_str + "model.th"
    vocab_path = "tmp\\" + EMBEDDING_TYPE + "_amazon_" + "vocab"
